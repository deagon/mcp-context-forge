...
> By default, they require Bearer token authentication. Setting `DOCS_ALLOW_BASIC_AUTH=true` enables 
> HTTP Basic Authentication as an additional method using the same credentials as `BASIC_AUTH_USER` 
